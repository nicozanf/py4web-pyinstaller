...
a = Analysis(['py4web-start.py'],
             ...
             hiddenimports=['cgitb', 'click', 'cryptography', 'http.cookies', 'json', 'jwt', 'numbers', 'ombott', 'pkg_resources.py2_warn', 'pluralize', 'pydal', 'pydal.restapi',
                            'pydal.tools', 'pydal.tools.tags', 'jwt', 'renoir', 'requests', 'rocket3', 'threadsafevariable', 'tornado', 'yatl', 'uuid',
                            ...
                            'poplib', 'posix', 'profile', 'pstats', 'psycopg2', 'pty', 'pwd', 'pyclbr', 'readline', 'resource', 'rlcompleter', 'secrets', 'shelve', 'smtpd', 'sndhdr',
