...
a = Analysis(['py4web-start.py'],
             ...
             binaries=[],
             datas=[],
             hiddenimports=['bottle', 'cgitb', 'click', 'colorama', 'http.cookies', 'json', 'jwt', 'numbers', 'pkg_resources.py2_warn', 'pluralize', 'pydal', 'pydal.restapi',
                            'requests', 'threadsafevariable', 'yatl', 'uuid', 'watchgod',
                            ...
                            'trace', 'turtle', 'turtledemo', 'urllib.robotparser', 'venv', 'wave', 'winreg', 'xdrlib', 'xml.dom',
